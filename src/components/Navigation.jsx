                      ...
                      <div className="space-y-2">
                        {themes.map((themeOption, index) => (
                          <button
                            ...
                            className={`w-full flex items-center space-x-4 px-4 py-3 ${theme === 'windows1992' ? 'rounded-none border-2 hover:bg-muted button-win95' : 'rounded-xl'} transition-all duration-300 text-left group hover-lift press-effect relative overflow-hidden ${
            ...
            <div className="px-4 py-6 space-y-3">
              {navItems.map((item, index) => (
                <button
                  key={item.id}
                  onClick={() => handleNavItemClick(item.id)}
                  className={`w-full flex items-center space-x-4 px-6 py-4 ${theme === 'windows1992' ? 'rounded-none border-2 hover:bg-muted button-win95' : 'rounded-xl'} transition-all duration-300 text-left group hover-lift press-effect relative overflow-hidden ${
                    currentView === item.id
                      ? theme === 'windows1992'
                        ? 'bg-primary text-primary-foreground border-inset'
